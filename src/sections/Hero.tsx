    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="space-y-4">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold text-emerald-900 animate-slideInDown opacity-0" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
            Diya Jain
          </h1>

          <h2 className="text-2xl md:text-3xl text-emerald-600 font-bold animate-slideInDown opacity-0" style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
            Full Stack MERN Developer
          </h2>

          <p className="text-gray-700 leading-relaxed text-lg animate-slideInDown opacity-0" style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
          ...
          {/* Social Icons */}
          <div className="flex gap-4 pt-4 animate-slideInDown opacity-0" style={{ animationDelay: '0.6s', animationFillMode: 'forwards' }}>

            <a
              href="https://github.com/Diyajain3"
              target="_blank"
              rel="noopener noreferrer"
              className="group relative bg-emerald-600 p-3 rounded-full text-white hover:bg-emerald-700 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-emerald-400/50"
            >
              <Github size={22} />
          ...
          {/* Buttons */}
          <div className="flex flex-wrap gap-4 pt-6 animate-slideInDown opacity-0" style={{ animationDelay: '0.7s', animationFillMode: 'forwards' }}>

            <a
              href="https://drive.google.com/file/d/18xJDvmKCIYnMFQ8UDu0qaTIf_3FFQTLQ/view"
              target="_blank"
              rel="noopener noreferrer"
              className="group relative bg-gradient-to-r from-emerald-600 to-emerald-500 text-white px-8 py-3 rounded-full font-semibold hover:from-emerald-700 hover:to-emerald-600 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-400/50 hover:scale-105 overflow-hidden"
            >
            ...
            <a
              href="#contact"
              className="group relative border-2 border-emerald-600 text-emerald-600 px-8 py-3 rounded-full font-semibold hover:bg-emerald-600 hover:text-white transition-all duration-300 hover:shadow-lg hover:shadow-emerald-400/50 hover:scale-105 flex items-center gap-2 overflow-hidden"
            >
